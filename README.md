  ...
  <body>
    ...
    <header>
      ...
      <nav>
        ...
        <li><a href="#">갤러리 여행</a></li>
        <li><a href="#">문의하기 여행</a></li>
      </nav>
      <hr />
    </header>
    <!-- 메인 영역 -->
    <main>
      <section>
        <h2>몸과 마음이 치유되는 섬</h2>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia delectus quam, laudantium in nihil est nesciunt, amet inventore asperiores aliquam necessitatibus saepe minus tenetur esse dolores. Alias temporibus ea tempora.
      </section>
      <section>
...
- 순서 있는 목록, ol
- 순서가 없는 목록 ul
- 설명 목록을 만드는 dl, dt, dd 태그 dl : description listdt dt : 제목 dd : 값(설명)
...
- 멀티미디어 파일을 삽입할 때 쓴느 object, embed 태그
- audio, vedio
...
- form 태그 속성
  ...
  - target : actoin 속성에서 지정한 스크립트 파일을 현재 창이 아닌 다른 위치에서 열도록 함
